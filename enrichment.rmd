...
GSEA <- GSEA_plots(pathways, Plot_title, Control, Test, res =  paste0(results_dir, "deseq2_results_annotated.tsv"))
...
```{r decoupleR_PROGENy, eval=FALSE, include=FALSE}
#BiocManager::install("OmnipathR")
#BiocManager::install("remotes")
#BiocManager::install("dorothea")
invisible(gc())
...
```{r decoupleR_PROGENy_Degs, eval=FALSE, include=FALSE}
# Extract t-values per gene
